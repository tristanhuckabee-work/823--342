...
print('module' in d1)  #  "module"    should be True
print('subject' in d1) #  "subject"   should be True
print('age' in d1)     #  "age"       should be False
print(1 in d1)         #  1           should be True
print('1' in d1)       #  "1"         should be True
print('one' in d1)     #  "one"       should be False
print(True in d1)      #  True        should be False
